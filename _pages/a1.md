...
<figure id="cell-ex-figure" class="l-body-outset">
  <div class="row">
    <img src="{{ 'assets/img/assignments/flamegraph.png' | relative_url }}" width="50%" />
  </div>
  <figcaption>
...
* Which one is slowest and why is it slowest? Please use [perf](https://www.brendangregg.com/perf.html) to profile the process model and explain where the bottleneck is.
